 ...
 * at the top, fading down) in the in-progress status colour (amber), styled like the
 * job-offer detail screen's top glow. Token-driven + dark-adaptive via
 * --color-status-progress; pointer-events-none and aria-hidden, shown from `sm:` up.
 */
function TopGlow() {
  return (
    <div
