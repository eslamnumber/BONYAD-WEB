...
│   │   ├── layout/              # AppShell, Sidebar (role-aware: SP vs customer nav + account menu — dashboard-sidebar.tsx + sidebar-nav-config.ts + sidebar-settings-menu.tsx), Header, Footer
