...
- Each doc stays under ~150 lines. If it grows past that, split into a follow-up doc. **Exception: generated data docs** (currently only [rn-call-site-index.md](rn-call-site-index.md)) are exempt — they are machine-emitted lookup tables, never hand-edited, regenerated by a script.
